...
using IniColorCycleCoreBlade = Layers<ColorCycleX<RgbArg<BASE_COLOR_ARG,Blue>,IntArg<CYCLE_OFF_PCT_ARG,0>,IntArg<CYCLE_OFF_RPM_ARG,1>,RgbArg<ALT_COLOR_ARG,Cyan>,IntArg<CYCLE_ON_PCT_ARG,30>,IntArg<CYCLE_ON_RPM_ARG,600>,IntArg<CYCLE_FADE_ARG,1000>,RgbArg<ALT_COLOR2_ARG,Black>>, ResponsiveLockupL<RgbArg<LOCKUP_COLOR_ARG,White>,TrInstant,TrFade<100>,Int<26000>>, ResponsiveLightningBlockL<RgbArg<LB_COLOR_ARG,White>>, ResponsiveMeltL<Mix<TwistAngle<>,Red,Yellow>>, ResponsiveDragL<RgbArg<DRAG_COLOR_ARG,White>>, ResponsiveClashL<RgbArg<CLASH_COLOR_ARG,White>,TrInstant,TrFade<200>,Int<26000>>, ResponsiveBlastL<RgbArg<BLAST_COLOR_ARG,White>>, ResponsiveBlastWaveL<RgbArg<BLAST_COLOR_ARG,White>>, ResponsiveBlastFadeL<RgbArg<BLAST_COLOR_ARG,White>>, ResponsiveStabL<RgbArg<STAB_COLOR_ARG,White>>, InOutTrL<TrFadeX<IntArg<IGNITION_TIME_ARG,300>>,TrFadeX<IntArg<RETRACTION_TIME_ARG,500>>,ColorCycleX<RgbArg<BASE_COLOR_ARG,Blue>,IntArg<CYCLE_OFF_PCT_ARG,0>,IntArg<CYCLE_OFF_RPM_ARG,1>,RgbArg<ALT_COLOR_ARG,Cyan>,IntArg<CYCLE_ON_PCT_ARG,30>,IntArg<CYCLE_ON_RPM_ARG,600>,IntArg<CYCLE_FADE_ARG,1000>,RgbArg<ALT_COLOR2_ARG,Black>>>>;
